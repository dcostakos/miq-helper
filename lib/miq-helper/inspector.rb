  ...
  module Inspector
    ...
    def dump_attributes(object_type, object)
      ...
      if object.respond_to?('attributes')
        ...
        object.attributes.sort.each { |k, v| log(:info, "\t #{object.name rescue object.description rescue nil} - Attribute: #{k.inspect} = #{v.inspect}") }
      elsif object.respond_to?('each')
        object.each { |obj| obj.attributes.sort.each { |k,v| log(:info, "\t #{obj.name rescue obj.description rescue nil} - Attribute: #{k.inspect} = #{v.inspect}")}}
